...
The opening promotion is a temporary offer valid from 24/05/2026 until 31/07/2026, and is strictly limited to first-time customers only. This offer can be claimed by applying the designated promotional code at checkout to receive 25% off on the first invoice, on select services only (eg: Minecraft hosting, Discord bot hosting) Future renewals will bill at the standard recurring rate. 050nodes reserves the right to cancel any orders that bypass these terms
