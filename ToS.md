...
The opening promotion is a temporary offer and is strictly limited to first-time customers only (maximum of one promotional server per household/account). The promotion consists of 3 months of hosting for the price of 2 months. The discount is applied when the designated promotional code is used at checkout, only on select services. Future renewals will bill at the standard quarterly rate. 050nodes reserves the right to cancel any orders that bypass these terms. Valid through 24/05/2026 till 31/07/2026.
