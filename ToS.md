...
You agree to use our Services only for lawful purposes. You are strictly prohibited from using the Services for activities that include, but are not limited to:

* **Resource Abuse**: Running scripts or processes that consistently overload the CPU, RAM, or network port, causing degradation of service for other users.
* **Malicious Activities**: Directing, participating in, or facilitating DDoS/DoS attacks, port scanning, or distributing malware, viruses, and trojans.
* **Network Misuse**: Sending unsolicited bulk emails (spam), operating open proxies, or using the network for unauthorized crypto-mining.
* **Illegal Content**: Hosting, storing, or transmitting copyrighted material without authorization, or hosting any content that violates Dutch or international law.
* **Game Server Misuse (Minecraft)**: Using public exploits, network crashers, or automated botnets designed to disrupt other game networks.

050nodes reserves the right to immediately suspend or terminate any service found in violation of this fair use policy, at our sole discretion, without prior notice and without any liability for data loss or service disruption.

## Section 4.0 - Limitation of Liability
In the event the hosting services provided to the Customer are disrupted or malfunction for any reason, the Provider's liability shall - except where limited by Dutch law in cases of willful misconduct ('opzet') or gross negligence ('grove schuld') - be limited to damages which shall not exceed the amount due and payable by the Customer to the Provider for the hosting services during the exact period of disruption or malfunction.

## Section 5.0 - Amendments to the Terms
050nodes reserves the right to modify or replace these Terms of Service. If a revision is material (such as changes to pricing, core services, or your consumer rights), we will provide at least 30 days' notice prior to the new terms taking effect. If you do not agree to the revised terms, you have the right to terminate your account or agreement with us free of charge before the changes come into effect. By continuing to access or use our Services after the 30-day notice period, you agree to be bound by the revised terms.
